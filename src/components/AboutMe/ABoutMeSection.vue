...
<template>
    <section v-scrollanimation class="about-me mx-auto mb-100px">
            ...
            <div class="about-me-text">
                <div class="about-me-text-info text-right max-w-500px">
                    <div>
                        ...
                        <div class="lg:text-size-52px md:text-size-44px text-size-36px font-600 text-[var(--primary)] tracking-tight mt-10px">Hi there, I’m Antonio</div>
        ...
        <div class="md:text-size-24px text-size-20px md:px-10px w-[100%] max-w-[770px] pt-100px md:leading-relaxed leading-relaxed relative">
            <div class="mb-30px">
                My name is Antonio . I’m a developer with a full-stack background and a keen eye for good design. I love to make complex things simple and joy to
