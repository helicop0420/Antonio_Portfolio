    ...
    <div class="header" :class="{ 'navbar--hidden': !showNavbar && scroll > 100, 'nav-min': scroll > 50 }">
        <nav>
            ...
            <div class="navs">
                <div class="nav-o">
                    ...
                    <div v-scrollanimation style="transition-delay: 650ms">
                        <a class="text-size-14px font-500" rel="external" href="https://blog.broAntonio.com" hreflang="es-es">
                            <Icon size="20">
                                <WebAsset24Filled />
                            </Icon>
                            Blog
            ...
            <div class="nav-mobile">
                <ol>
                    <li>
                        <div @click="openSite('https://www.facebook.com//')" class="a-link">
                    ...
                    <li>
                        <div @click="openSite('https://www.linkedin.com/in/Antonio/')" class="a-link">
                            <div class="text-size-25px">
                    ...
                    <li>
                        <div @click="openSite('https://github.com/BroAntonio')" class="a-link">
                            <div class="text-size-25px">
                    ...
                    <li>
                        <div @click="openSite('https://twitter.com/broAntonio')" class="a-link">
                            <div class="text-size-25px">
                    ...
                    <li>
                        <div @click="openSite('https://dev.to/broAntonio')" class="a-link">
                            <div class="text-size-25px">
